...
namespace DatabaseSizer.Helpers
{
    ...
    public sealed class ProgressReporter
    {
        ...
        {
            return Task.Factory.StartNew(action, CancellationToken.None, TaskCreationOptions.None, this._scheduler);
        }
        ...
        {
            return task.ContinueWith(_ => action(), CancellationToken.None, TaskContinuationOptions.None, this._scheduler);
        }
        ...
        public Task RegisterSucceededHandler(Task task, Action action)
        {
            return task.ContinueWith(_ => action(), CancellationToken.None,
                                     TaskContinuationOptions.OnlyOnRanToCompletion, this._scheduler);
        }
